...
<form method="POST" action="{{ route('adminprofile.update', $user) }}" >
    @csrf
    @method('PUT')
    <x-alert.form-alert/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('username', $profile->username) }}" name="username" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Alamat Email</label>
                                    <input class="form-control" type="email" value="{{ old('email', $profile->email) }}" name="email">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Nama Klinik</label>
                                    <input class="form-control" type="text" value="{{ old('nama_klinik', $profile->nama_klinik) }}" name="nama_klinik">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    value="{{ old ('alamat_lengkap', $profile->alamat_lengkap)}}" name="alamat_lengkap">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="kecamatan" name="kecamatan">
                                        ...
                                        <option value="Cipanas" {{ strtolower($profile->kecamatan) == 'cipanas' ? 'selected' : '' }}>Cipanas</option>
                                        <option value="Pacet" {{ strtolower($profile->kecamatan) == 'pacet' ? 'selected' : '' }}>Pacet</option>
                                        <option value="Sukaresmi" {{ strtolower($profile->kecamatan) == 'sukaresmi' ? 'selected' : '' }}>Sukaresmi</option>
                                        <option value="Cugenang" {{ strtolower($profile->kecamatan) == 'cugenang' ? 'selected' : '' }}>Cugenang</option>
                                        <option value="Cikalong Kulon" {{ strtolower($profile->kecamatan) == 'cikalong kulon' ? 'selected' : '' }}>Cikalongkulon</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('kabupaten', $profile->kabupaten)}}" name="kabupaten">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Kode Pos</label>
                                    <input class="form-control" type="text" value="{{ old('kode_pos', $profile->kode_pos)}}" name="kode_pos">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('whatsapp', $profile->whatsapp)}}" name="whatsapp" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Telephone</label>
                                    <input class="form-control" type="text" value="{{ old('telephone', $profile->telephone)}}" name="telephone">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Instagram</label>
                                    <input class="form-control" type="text" value="{{ old('instagram', $profile->instagram)}}" name="instagram" >
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Facebook</label>
                                    <input class="form-control" type="text" value="{{ old('facebook', $profile->facebook)}}" name="facebook" >
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Website Klinik</label>
                                    <input class="form-control" type="text" value="{{ old('website_klinik', $profile->website_klinik) }}" name="website_klinik">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text"
                                    value="{{ old('tentangklinik', $profile->tentangklinik)}}" name="tentangklinik">
                                </div>
                            </div>
