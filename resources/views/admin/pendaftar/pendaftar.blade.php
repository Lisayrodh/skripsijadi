...
<head>
  ...
  <body>
      <div class="container-fluid py-4">
          <div class="row">
              <div class="col-md-12">
                  <h2 class="text-center">Daftar Pendaftar ke {{ $admin_name }}</h2>
                      ...
                      <table class="table table-bordered">
                          <thead>
                              <tr>
                                  ...
                                  <th>No Tlp./Whatsapp Orang Tua</th>
                                  <th>Alamat</th>
                                  <th>Klinik</th>
                          ...
                          <tbody>
                              @foreach($registrants as $index => $registrant)
                                  <tr>
                                      ...
                                      <td>{{ $registrant->usia }}</td>
                                      <td>{{ $registrant->jenis_kelamin }}</td>
                                      <td>{{ $registrant->nama_orang_tua }}</td>
                                      <td>{{ $registrant->whatsapp }}</td>
                                      <td>{{ $registrant->whatsapportu }}</td>
                                      <td>{{ $registrant->alamat }}</td>
                                      <td>{{ $registrant->clinic->name }}</td>
                                      <td>{{ $registrant->riwayat_kesehatan }}</td>
                                      <td>
 ...
 <style>
    body {
      margin-bottom: 100px; /* Margin besar di bawah body */
    }
    footer {
      margin-top: 400px; /* Margin besar di atas footer */
    }
  </style>
 <!-- ======= Footer ======= -->
