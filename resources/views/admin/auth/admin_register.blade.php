...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Klinik Register')
@section('register')
  ...
  <body>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        ...
        <a href="{{ route('admin.login')}}" class="appointment-btn scrollto"><span class="d-none d-md-inline">Clinic Login</span></a>
      </div>
    </header><!-- End Header -->
<!-- ======= Hero Section ======= -->
<section id="herodas1" class="d-flex align-items-center mb-6">
    <div class="container">
            ...
            <div class="col-md-6 col-lg-5" >
                <div class="login-box bg-white box-shadow border-radius-10 mb-10">
                    <div class="login-tittle mb-10">
                        <h3 class="text-center text-primary mb-20">Create Clinic Account</h3>
                    </div>
                </div>
                <form action="{{ route('createadmin') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter clinic email" name="email"
                        value="{{ old('email')}}">
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
