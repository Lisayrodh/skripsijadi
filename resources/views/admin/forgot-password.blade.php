...
<!-- ======= Hero Section ======= -->
<section id="herodas" class="d-flex align-items-center">
    <div class="container d-flex flex-column flex-md-row align-items-center">
        <h1 class="mr-md-5">Forgot Password</h1>
        <div class="login-box bg-white box-shadow border-radius-5">
            <div class="login-title">
                <h2 class="text-center text-primary">Forgot Password</h2>
            </div>
            <h6 class="mb-20">Enter your email address to reset your password</h6>
                                    <form action="{{ route('send-password-reset-link')}}" method="POST" style="margin: 0 20px;"> <!-- Change the min-width as needed -->
                                        @csrf
                                        <x-alert.form-alert/>
                                        <div class="input-group custom" style="margin-bottom: 30px;"> <!-- Increased margin bottom -->

                                            <input
                                                type="email"
                                                class="form-control form-control-lg"
                                                placeholder="Email" name="email" value="{{ old('email')}}" style="border-radius: 10px;"/>
                                        ...
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-md-4 text-center" style="margin-bottom: 20px;"> <!-- Increased margin bottom -->
                                                <div class="input-group mb-0">
                                                    <input class="btn btn-primary btn-lg btn-block btn-sm"
                                                    type="submit" value="Submit" style="border-radius: 10px;">
                                                </div>
                                            </div>

                                            <div class="col-md-4 text-center" style="margin-bottom: 20px;"> <!-- Increased margin bottom -->
                                                <div class="font-16 weight-700" data-color="#707373">
                                                    OR
                                                </div>
                                            </div>

                                            <div class="col-md-4 text-center" style="margin-bottom: 20px;"> <!-- Kolom ketiga -->
                                                <div class="input-group mb-0">
                                                    <a class="btn btn-outline-primary btn-lg btn-block btn-sm"
                                                    href="{{ route('admin.login')}}" style="border-radius: 10px;">Login</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
