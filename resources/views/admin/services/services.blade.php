...
<body>
  ...
  <section class="mt-3">
    <div class="container d-flex flex-column align-items-center">
        <div class="mb-4 bg-light rounded p-3" style="width: 50%;">
            <h3 class="text-center">Pelayanan </h3>
            <h3 class="text-center">{{ $admin_name }}</h3>
        </div>

        <div class="w-100 d-flex flex-column align-items-center">
            <div style="text-align: left; margin-bottom: 10px; display: flex; justify-content: flex-start;  margin-right: 60%;">
                <a href="{{ route('services.create', $adminId) }}" class="btn btn-primary" style="border-radius: 20px;">Tambah ➕</a>
            </div>
                        ...
                        @foreach ($dataServices as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('services.destroy', $item->id_services) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
