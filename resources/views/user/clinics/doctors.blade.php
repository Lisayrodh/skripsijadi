...
<head>
  ...
  <section id="clinic-doctor" class="d-flex align-items-center" style="padding: 100px 0;">
    <div class="container container-bg">
        <h1 class="text-centeruser">Daftar Dokter dan Perawat {{ $clinic->name }}</h1>
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    @forelse($clinic->doctors as $doctor)
                        <div class="col-md-6 mb-4">
                            <div class="carddoc border-primary">
                                <div class="text-center mt-5">
                                </div>
                                <div class="carddoc-body text-center">
                                    <img src="{{ asset('storage/' . $doctor->photo) }}" alt="{{ $doctor->name }}" class="rounded-circle mx-auto d-block" style="width: 150px; height: 150px; object-fit: contain;">
                                    <h4 class="carddoc-title">{{ $doctor->name }}</h4>
                                    <p class="carddoc-text">{{ $doctor->position }}</p>
                                    <p class="carddoc-text">{{ $doctor->description }}</p>
                                    <div class="social">
                                        @if ($doctor->twitter)
                    ...
                    @empty
                        <div class="col-md-12">
                            <p>Data dokter tidak tersedia untuk klinik ini.</p>
                        </div>
                    @endforelse
                </div>
            </div>
            <div class="col-md-4 mt-5">
                <div class="card card-profile">
                    ...
                    <div class="card-header text-center border-0 pt-0 pt-lg-2 pb-4 pb-lg-3">
                        ...
                        <ul>
                            <a href="{{ route('user.clinic.profile', $clinic->id_admin) }}" class="buttonuser">Profile</a>
                            <a href="{{ route('user.clinic.services', $clinic->id_admin) }}" class="buttonuser">Pelayanan</a>
