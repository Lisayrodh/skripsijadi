...
<head>
    ...
    <title>Rincian Pendaftaran</title>
</head>
<body>
    <h1>Rincian Pendaftaran</h1>
    <p>Berikut adalah rincian data pendaftaran:</p>
    ...
    <ul>
        ...
        <li>Nama Orang Tua: {{ $data['nama_orang_tua'] }}</li>
        <li>No Tlp./Whatsapp: {{ $data['whatsapp'] }}</li>
        <li>No Tlp./Whatsapp Orang Tua: {{ $data['whatsapportu'] }}</li>
        <li>Alamat Lengkap: {{ $data['alamat'] }}</li>
        <li>Pilihan Klinik: {{ $data['klinik'] }}</li>
        <li>Riwayat Kesehatan: {{ $data['riwayat_kesehatan'] }}</li>
    </ul>

    <p><a href="{{ route('user.clinics') }}">Kembali List Klinik</a></p>
</body>
