            ...
            <div style="text-align: center;">
                <div style="display: flex; justify-content: center;">
                    <div style="margin: 20px;">
                      <img src="<?php echo asset('assets/img/apa_itu_khitan.jpg');?>" alt="Informasi Khitan" class="img-fluid" style="width: 500px;">
                    </div>
                    <div style="margin: 20px;">
                      <img src="<?php echo asset('assets/img/persiapan_khitan.jpg');?>" alt="Informasi Khitan" class="img-fluid" style="width: 500px;">
                    </div>
                  </div>
