        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li class="dropdown"><a href="#"><span class="appointment-btn scrollto">Login</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
                  <li><a href="{{ route('admin.login')}}"> Login Klinik</a></li>
                  <li><a href="{{ route('user.login')}}"> Login Publik</a></li>
                </ul>
            </li>
          </ul>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            ...
            <div class="icon-box">
              ...
              <h4 class="title"><a href="{{ route('metode-khitan')}}">Metode Khitan</a></h4>
            ...
            <div class="icon-box">
              ...
              <h4 class="title"><a href="{{ route('biaya-khitan')}}">Biaya Khitan</a></h4>
              <p class="description">Kami menyediakan informasi menyenai biaya layanan khitan</p>
            </div>

            <div class="icon-box">
              <div class="icon"><i class="bx bx-map"></i></div>
              <h4 class="title"><a href="{{ route('lokasi-khitan')}}">Lokasi Layanan Khitan</a></h4>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="{{ route('pendaftaran-khitan')}}">Pendaftaran Khitan</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="{{ route('konsultasi-khitan')}}">Konsultasi Khitan</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="{{ route('edukasi-khitan')}}">Edukasi</a></h4>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container">
        ...
        <a href="{{ route('feedback.form') }}" class="floating-button">Saran</a>
      </div>
